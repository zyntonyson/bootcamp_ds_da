...
* 👋 Bienvenida {5}
* ☕ Modelado de datos con Power BI: Instituto Internacional de Agricultura Sostenible (IIAS) {90}
...
* ☕ Diseñar un **dashboard interactivo** que de herramientas a los directores del Instituto Internacional de Agricultura Sostenible (IIAS) para la toma de decisiones.
